...
const { createCategory, createSubcategory, getAllCategories, updateCategory, deleteCategory, updateSubcategory, deleteSubcategory, getSubcategory } = require('../controllers/categoriesController');
